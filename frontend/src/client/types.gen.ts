 ...
 */
export type ActionType = 'created' | 'updated' | 'deleted' | 'moved' | 'archived' | 'restored' | 'completed' | 'assigned' | 'commented' | 'invited' | 'joined' | 'left';
 ...
 */
export type EntityType = 'card' | 'list' | 'board' | 'workspace' | 'comment' | 'checklist_item' | 'member';
 ...
 */
export type NotificationType = 'workspace_invitation' | 'invitation_accepted' | 'invitation_rejected' | 'comment_added' | 'card_assigned' | 'card_due_soon' | 'mentioned' | 'card_moved' | 'checklist_toggled';
...
export type ActivityGetBoardActivityData = {
    boardId: string;
    limit?: number;
    skip?: number;
};

export type ActivityGetBoardActivityResponse = (ActivityLogsPublic);

export type ActivityGetWorkspaceActivityData = {
    limit?: number;
    skip?: number;
    workspaceId: string;
};

export type ActivityGetWorkspaceActivityResponse = (ActivityLogsPublic);

export type ActivityGetCardActivityData = {
    cardId: string;
    limit?: number;
    skip?: number;
};

export type ActivityGetCardActivityResponse = (ActivityLogsPublic);
...
export type OauthOauthStatusResponse = (unknown);
...
export type UploadsUploadImageResponse = ({
    [key: string]: unknown;
});
...
export type UploadsGetFileResponse = (unknown);
